    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Início">
                <a class="nav-link" href="http://furiouscollections.rf.gd/client/painel.php">
            ...
            <li class="nav-item active" data-toggle="tooltip" data-placement="right" title="Plugins">
                <a class="nav-link" href="http://furiouscollections.rf.gd/client/plugins">
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="h4 font-weight-light mb-3">Seus plugins</div>
