...
$consulta = "SELECT * FROM `plugins` WHERE `preco` = 'Pago'";
...
<head>
    ...
    <title>furiouscollections — Plugins Pagos</title>
...
<main role="main">
        ...
        <div class="mid">
            <div class="container">
                <h1>Plugins Pagos</h1>
                <h2>Impulsione seu servidor com os melhores plugins!</h2>
            </div>
        </div>
    </section>
            ...
            <a href="http://furiouscollections.rf.gd/plugins/" class="category-selector active">
                <div class="category-item">
                    ...
                    <span>
                        ...
                        <a href="http://furiouscollections.rf.gd/plugins/pagos" class="category-selector ">
                <div class="category-item">
                    <span>
                        Pagos                    </span>
                </div>
        ...
        <?php while($dado = $con->fetch_array()){ ?>
                ...
                <div class="product">
                    ...
                    <div class="product-buttons">
                        <button class="product-btn" onclick="location.href = 'infopl.php?plugin=<?php echo $dado['nome']; ?>' ">Mais detalhes</button>
                    </div>
                </div>
            </div>
            <?php } ?>
